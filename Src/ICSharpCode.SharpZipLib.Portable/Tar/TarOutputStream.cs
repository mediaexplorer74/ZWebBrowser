...
namespace ICSharpCode.SharpZipLib.Tar
{
  public class TarOutputStream : Stream
  {
    ...
    public override long Seek(long offset, SeekOrigin origin) => this.outputStream.Seek(offset, origin);
    ...
    public override int Read(byte[] buffer, int offset, int count) => this.outputStream.Read(buffer, offset, count);
