...
namespace ICSharpCode.SharpZipLib.Tar
{
  public class TarBuffer
  {
    ...
    public static TarBuffer CreateInputTarBuffer(Stream inputStream) => inputStream != null ? TarBuffer.CreateInputTarBuffer(inputStream, 20) : throw new ArgumentNullException(nameof (inputStream));
    ...
    public static TarBuffer CreateOutputTarBuffer(Stream outputStream) => outputStream != null ? TarBuffer.CreateOutputTarBuffer(outputStream, 20) : throw new ArgumentNullException(nameof (outputStream));
