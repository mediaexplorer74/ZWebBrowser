...
namespace ICSharpCode.SharpZipLib.Zip.Compression
{
  public class DeflaterHuffman
  {
    ...
    public static short BitReverse(int toReverse) => (short) ((int) DeflaterHuffman.bit4Reverse[toReverse & 15] << 12 | (int) DeflaterHuffman.bit4Reverse[toReverse >> 4 & 15] << 8 | (int) DeflaterHuffman.bit4Reverse[toReverse >> 8 & 15] << 4 | (int) DeflaterHuffman.bit4Reverse[toReverse >> 12]);
