...
namespace ICSharpCode.SharpZipLib.Checksums
{
  public sealed class Crc32 : IChecksum
  {
    ...
    private uint crc;
        ...
        {
            //RnD
            return default;//Crc32.CrcTable[(IntPtr)(uint)(((int)oldCrc ^ (int)value) & (int)byte.MaxValue)] ^ oldCrc >> 8;
        }
    ...
    public void Update(byte[] buffer, int offset, int count)
    {
      ...
      this.crc ^= uint.MaxValue;
            ...
            {
                //RnD
                this.crc = default;//Crc32.CrcTable[(IntPtr)(uint)(((int)this.crc ^ (int)buffer[offset++]) & (int)byte.MaxValue)] ^ this.crc >> 8;
            }
